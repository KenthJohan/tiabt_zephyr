...
MY_UUID_SRV(MYSRV_UUID_SRV4),
MY_UUID_SRV(MYSRV_UUID_SRV5),
};

const struct bt_uuid_128 uuids_chrc[] = {
[MYID_APP_PRINT_MODE] = MY_UUID_CHRC(MYID_APP_PRINT_MODE),
[MYID_APP_VREG1_EN] = MY_UUID_CHRC(MYID_APP_VREG1_EN),
[MYID_APP_VREG2_EN] = MY_UUID_CHRC(MYID_APP_VREG2_EN),
...
[MYID_CH0_PIKO_A] = MY_UUID_CHRC(MYID_CH0_PIKO_A),
[MYID_CH1_PIKO_A] = MY_UUID_CHRC(MYID_CH1_PIKO_A),
[MYID_CH2_PIKO_A] = MY_UUID_CHRC(MYID_CH2_PIKO_A),
[MYID_CH3_PIKO_A] = MY_UUID_CHRC(MYID_CH3_PIKO_A),
[MYID_CH4_PIKO_A] = MY_UUID_CHRC(MYID_CH4_PIKO_A),
[MYID_CH5_PIKO_A] = MY_UUID_CHRC(MYID_CH5_PIKO_A),
[MYID_CH6_PIKO_A] = MY_UUID_CHRC(MYID_CH6_PIKO_A),
[MYID_CH7_PIKO_A] = MY_UUID_CHRC(MYID_CH7_PIKO_A),
[MYID_CH0_RESISTOR_FB] = MY_UUID_CHRC(MYID_CH0_RESISTOR_FB),
[MYID_CH1_RESISTOR_FB] = MY_UUID_CHRC(MYID_CH1_RESISTOR_FB),
[MYID_CH2_RESISTOR_FB] = MY_UUID_CHRC(MYID_CH2_RESISTOR_FB),
[MYID_CH3_RESISTOR_FB] = MY_UUID_CHRC(MYID_CH3_RESISTOR_FB),
[MYID_CH4_RESISTOR_FB] = MY_UUID_CHRC(MYID_CH4_RESISTOR_FB),
[MYID_CH5_RESISTOR_FB] = MY_UUID_CHRC(MYID_CH5_RESISTOR_FB),
[MYID_CH6_RESISTOR_FB] = MY_UUID_CHRC(MYID_CH6_RESISTOR_FB),
[MYID_CH7_RESISTOR_FB] = MY_UUID_CHRC(MYID_CH7_RESISTOR_FB),
};
