...
BT_GATT_SERVICE_DEFINE(gatt,
	...
	BT_GATT_CHARACTERISTIC((const struct bt_uuid *)&uuids_chrc[MYID_APP_VREG1_EN], BT_GATT_CHRC_WRITE | BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_signed, write_signed, &app.values[MYID_APP_VREG1_EN]),
	BT_GATT_CCC(ccc_cfg_changed1, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE),
	BT_GATT_CUD("APP_VREG1_EN", BT_GATT_PERM_READ),
	BT_GATT_CPF(&cpf_dpot),

	BT_GATT_CHARACTERISTIC((const struct bt_uuid *)&uuids_chrc[MYID_APP_VREG2_EN], BT_GATT_CHRC_WRITE | BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_signed, write_signed, &app.values[MYID_APP_VREG2_EN]),
	BT_GATT_CCC(ccc_cfg_changed1, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE),
	BT_GATT_CUD("APP_VREG2_EN", BT_GATT_PERM_READ),
	BT_GATT_CPF(&cpf_dpot),
	...
	BT_GATT_PRIMARY_SERVICE(&uuids_srv[MYSRV_UUID_SRV5]),
	BT_GATT_CHARACTERISTIC((const struct bt_uuid *)&uuids_chrc[MYID_CH0_RESISTOR_FB], BT_GATT_CHRC_WRITE | BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_signed, write_signed, &app.values[MYID_CH0_RESISTOR_FB]),
	BT_GATT_CCC(ccc_cfg_changed1, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE),
	BT_GATT_CUD("CH0_RESISTOR_FB", BT_GATT_PERM_READ),
	BT_GATT_CPF(&cpf_resistance),
	BT_GATT_CHARACTERISTIC((const struct bt_uuid *)&uuids_chrc[MYID_CH1_RESISTOR_FB], BT_GATT_CHRC_WRITE | BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_signed, write_signed, &app.values[MYID_CH1_RESISTOR_FB]),
	BT_GATT_CCC(ccc_cfg_changed1, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE),
	BT_GATT_CUD("CH1_RESISTOR_FB", BT_GATT_PERM_READ),
	BT_GATT_CPF(&cpf_resistance),
	BT_GATT_CHARACTERISTIC((const struct bt_uuid *)&uuids_chrc[MYID_CH2_RESISTOR_FB], BT_GATT_CHRC_WRITE | BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_signed, write_signed, &app.values[MYID_CH2_RESISTOR_FB]),
	BT_GATT_CCC(ccc_cfg_changed1, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE),
	BT_GATT_CUD("CH2_RESISTOR_FB", BT_GATT_PERM_READ),
	BT_GATT_CPF(&cpf_resistance),
	BT_GATT_CHARACTERISTIC((const struct bt_uuid *)&uuids_chrc[MYID_CH3_RESISTOR_FB], BT_GATT_CHRC_WRITE | BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_signed, write_signed, &app.values[MYID_CH3_RESISTOR_FB]),
	BT_GATT_CCC(ccc_cfg_changed1, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE),
	BT_GATT_CUD("CH3_RESISTOR_FB", BT_GATT_PERM_READ),
	BT_GATT_CPF(&cpf_resistance),
	BT_GATT_CHARACTERISTIC((const struct bt_uuid *)&uuids_chrc[MYID_CH4_RESISTOR_FB], BT_GATT_CHRC_WRITE | BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_signed, write_signed, &app.values[MYID_CH4_RESISTOR_FB]),
	BT_GATT_CCC(ccc_cfg_changed1, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE),
	BT_GATT_CUD("CH4_RESISTOR_FB", BT_GATT_PERM_READ),
	BT_GATT_CPF(&cpf_resistance),
	BT_GATT_CHARACTERISTIC((const struct bt_uuid *)&uuids_chrc[MYID_CH5_RESISTOR_FB], BT_GATT_CHRC_WRITE | BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_signed, write_signed, &app.values[MYID_CH5_RESISTOR_FB]),
	BT_GATT_CCC(ccc_cfg_changed1, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE),
	BT_GATT_CUD("CH5_RESISTOR_FB", BT_GATT_PERM_READ),
	BT_GATT_CPF(&cpf_resistance),
	BT_GATT_CHARACTERISTIC((const struct bt_uuid *)&uuids_chrc[MYID_CH6_RESISTOR_FB], BT_GATT_CHRC_WRITE | BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_signed, write_signed, &app.values[MYID_CH6_RESISTOR_FB]),
	BT_GATT_CCC(ccc_cfg_changed1, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE),
	BT_GATT_CUD("CH6_RESISTOR_FB", BT_GATT_PERM_READ),
	BT_GATT_CPF(&cpf_resistance),
	BT_GATT_CHARACTERISTIC((const struct bt_uuid *)&uuids_chrc[MYID_CH7_RESISTOR_FB], BT_GATT_CHRC_WRITE | BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_signed, write_signed, &app.values[MYID_CH7_RESISTOR_FB]),
	BT_GATT_CCC(ccc_cfg_changed1, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE),
	BT_GATT_CUD("CH7_RESISTOR_FB", BT_GATT_PERM_READ),
	BT_GATT_CPF(&cpf_resistance),
...
#define NOTFIER_COUNT 30
static const notify_t notifier[NOTFIER_COUNT] = {
	{&gatt, MYGATT_SRV1_APP_VREG1_EN_CHRC0, MYID_APP_VREG1_EN},
	{&gatt, MYGATT_SRV1_APP_VREG2_EN_CHRC0, MYID_APP_VREG2_EN},
